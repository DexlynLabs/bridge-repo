...
import { getTest1EthereumUSDCWarpConfig } from './environments/mainnet3/warp/configGetters/getTest1EthereumUSDCWarpConfig.js';
...
export const warpConfigGetterMap: Record<string, WarpConfigGetter> = {
  ...
  [WarpRouteIds.Test1EthereumUSDC]: getTest1EthereumUSDCWarpConfig,
};
...
export async function getWarpConfig(
  ...
  if (envConfig.environment !== 'test') {
    // TODO: need to deploy synthetic token for test here
