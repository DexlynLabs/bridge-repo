...
LN1_ADDRESS_MATHING="--named-addresses hp_library=$LN1_LIBRARY_ADDRESS,hp_validator=$LN1_VALIDATOR_ANNOUNCE_ADDRESS,hp_isms=$LN1_ISMS_ADDRESS,hp_igps=$LN1_IGPS_ADDRESS,hp_mailbox=$LN1_MAILBOX_ADDRESS,hp_router=$LN1_ROUTER_ADDRESS,examples=$LN1_EXAMPLES_ADDRESS,tokens=$LN1_TOKEN_ADDRESS"
...
fund_and_publish "tokens" $LN1_TOKEN_ADDRESS "../e2e/aptos-test-keys/localnet1/tokens-keypair.json" "$LN1_ADDRESS_MATHING"

LN2_ADDRESS_MATHING="--named-addresses hp_library=$LN2_LIBRARY_ADDRESS,hp_validator=$LN2_VALIDATOR_ANNOUNCE_ADDRESS,hp_isms=$LN2_ISMS_ADDRESS,hp_igps=$LN2_IGPS_ADDRESS,hp_mailbox=$LN2_MAILBOX_ADDRESS,hp_router=$LN2_ROUTER_ADDRESS,examples=$LN2_EXAMPLES_ADDRESS,synthetic_tokens=$LN2_TOKEN_ADDRESS"
...
fund_and_publish "synthetic-tokens" $LN2_TOKEN_ADDRESS "../e2e/aptos-test-keys/localnet2/tokens-keypair.json" "$LN2_ADDRESS_MATHING"
