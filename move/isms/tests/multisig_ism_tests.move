...
module hp_isms::multisig_ism_tests {
  ...
  fun test_fail_duplicate_validators(
    user: &signer
  ) {
    multisig_ism::init_for_test(user);
    multisig_ism::set_validators_and_threshold(user,vector[@0x123456,@0x123456,@0x1234567,@0x12345678,@0x123456789],3,BSC_TESTNET_DOMAIN);
  }
}